...
def contamination(text, character):
...
# Примеры
print(contamination("abc", "z"))  # Выведет "zzz"
print(contamination("hello", "*"))  # Выведет "*****"
print(contamination("", "z"))  # Выведет ""
print(contamination("abc", ""))  # Выведет ""
